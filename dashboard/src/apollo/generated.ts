...
export type GuildsQuery = {
  __typename?: "Query";
  guilds: Array<{ __typename?: "Guild"; id: string; name: string; icon: string }>;
};
...
export type GuildQuery = {
  ...
  guild: {
    __typename?: "Guild";
    id: string;
    currentlyPlaying: { __typename?: "Song"; title: string; url: string; thumbnail: string; duration: number };
    playbackStatus: { __typename?: "PlaybackStatus"; isPlaying: boolean };
    queue: Array<{ __typename?: "Song"; title: string; url: string; thumbnail: string; duration: number }>;
  };
};
